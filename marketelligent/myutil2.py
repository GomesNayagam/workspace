...
def normalize(f):
    ...
    f = [x.replace("lap top", "laptop") for x in f]
    f = [x.replace("mouse pad", "mousepad") for x in f]
    f = [x.replace("touch pad", "touchpad") for x in f]
    f = [x.replace("every time", "everytime") for x in f]
    f = [x.replace("any time", "anytime") for x in f]
    f = [x.replace("long time", "longtime") for x in f]
    f = [x.replace("..", "") for x in f]
    f = [x.replace("...", "") for x in f]
