...
MODELS_PATH = "models/fb_model.bin"
...
def run(verbose = True):
    ...
    X_tn = sp.hstack([X_train110, X_train11, X_train12, X_train13])
    ...
    model['metadata'] = {0: "pos_term", 1: "pos_ngram_term", 2: "pos_ngram_term", 3: "pos_ngram_term"}
